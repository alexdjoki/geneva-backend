...
def pick_best_answer(responses):
    ...
    prompt = f"""
    You are provided with multiple answers generated by different AI models in response to the same question. 

    Your task is to evaluate the responses and select the single best answer based on clarity, completeness, and relevance.
